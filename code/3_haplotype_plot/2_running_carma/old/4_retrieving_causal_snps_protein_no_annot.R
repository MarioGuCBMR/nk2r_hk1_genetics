...
for(loci in loci_){
  ...
  path_2_res <- paste("output/2_fine_mapping/protein/carma_res/", loci, ".RDS", sep="")
  path_2_ss <- paste("output/2_fine_mapping/protein/loci_ss_aligned/", loci, ".txt", sep="")
  ...
  output_path <- paste("output/2_fine_mapping/protein/carma_res_clean/", loci, "no_annot_01.txt", sep="")
